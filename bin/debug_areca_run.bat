...
SET "CLASSPATH=%CLASSPATH%;%LIB_PATH%commons-net.jar"
SET "CLASSPATH=%CLASSPATH%;%LIB_PATH%oro.jar"
SET "CLASSPATH=%CLASSPATH%;%LIB_PATH%jsch.jar"
SET "CLASSPATH=%CLASSPATH%;%LIB_PATH%commands.jar"
SET "CLASSPATH=%CLASSPATH%;%LIB_PATH%common.jar"
SET "CLASSPATH=%CLASSPATH%;%LIB_PATH%org.eclipse.jface.jar"
SET "CLASSPATH=%CLASSPATH%;%LIB_PATH%swt.jar"
SET "CLASSPATH=%CLASSPATH%;%LIB_PATH%commons-codec.jar"
...
IF "%P1_REQUIRED_LAUNCHER_CLASS%"=="com.application.areca.launcher.gui.Launcher" (
    ...
    :: Logging
    SET "ARECA_LOG=%PROGRAM_DIR%\logs\debug_areca_run.bat.log"
    ECHO SCRIPT:                    debug_areca_run.bat
