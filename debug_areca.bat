...
SET "ARECA_LAUNCHER=%PROGRAM_DIR%\debug_areca_run.exe"
SET "IS_EXE_LAUNCHER=1"

IF NOT EXIST "%ARECA_LAUNCHER%" (
    SET "ARECA_LAUNCHER=%PROGRAM_DIR%\bin\debug_areca_run.bat"
...
:: Logging
SET "ARECA_LOG=%PROGRAM_DIR%\logs\debug_areca_run.log"
